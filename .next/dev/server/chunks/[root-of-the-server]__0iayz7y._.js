...
async function POST(req) {
  ...
  `;
    if (existing.length > 0) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`delete from reactions where id = ${existing[0].id}`;
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            action: 'removed'
        });
    } else {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0iayz7y._.js.map